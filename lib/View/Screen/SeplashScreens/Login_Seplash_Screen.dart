...
class SeplashScreenLogin extends StatefulWidget {
  const SeplashScreenLogin({super.key});

  @override
  State<SeplashScreenLogin> createState() => _SeplashScreenLoginState();
}

class _SeplashScreenLoginState extends State<SeplashScreenLogin> {
